...
audio_file = "/Users/samridhtiwari/Desktop/Binary-UAV-Detection-main/Processing/Drone/Dronemain.wav"
print("File exists:", os.path.isfile(audio_file))

#%% Raw audio segmentation with 1 second

audio_file = "/Users/samridhtiwari/Desktop/Binary-UAV-Detection-main/Processing/No Drone/NoDrone.wav"
...
output_folder = "/Users/samridhtiwari/Desktop/Binary-UAV-Detection-main/Output/1D Features/Raw Audio/No Drone"
...
output_folder = "/Users/samridhtiwari/Desktop/Binary-UAV-Detection-main/Output/1D Features/Raw Audio/Drone"
os.makedirs(output_folder, exist_ok=True)
for snr in snr_values:
    for i in range(num_segments):
        start_sample = int(i * segment_length)
...
output_folder = "/Users/samridhtiwari/Desktop/Binary-UAV-Detection-main/Output/1D Features/MFCC 20/Drone"
os.makedirs(output_folder, exist_ok=True)
for snr in snr_values:
    for i in range(num_segments):
        start_sample = int(i * segment_length)
...
output_folder = "/Users/samridhtiwari/Desktop/Binary-UAV-Detection-main/Output/1D Features/MFCC 20/No Drone"
os.makedirs(output_folder, exist_ok=True)
for snr in snr_values:
    for i in range(num_segments):
        start_sample = int(i * segment_length)
...
output_folder = "/Users/samridhtiwari/Desktop/Binary-UAV-Detection-main/Output/1D Features/Mel 128/Drone"
os.makedirs(output_folder, exist_ok=True)
for snr in snr_values:
    for i in range(num_segments):
        start_sample = int(i * segment_length)
...
output_folder = "/Users/samridhtiwari/Desktop/Binary-UAV-Detection-main/Output/1D Features/Mel 128/No Drone"
os.makedirs(output_folder, exist_ok=True)
for snr in snr_values:
    for i in range(num_segments):
        start_sample = int(i * segment_length)
...
output_folder = "/Users/samridhtiwari/Desktop/Binary-UAV-Detection-main/Output/1D Features/PSD/Drone"
os.makedirs(output_folder, exist_ok=True)
for snr in snr_values:
    for i in range(num_segments):
        start_sample = int(i * segment_length)
...
output_folder = "/Users/samridhtiwari/Desktop/Binary-UAV-Detection-main/Output/1D Features/PSD/No Drone"
os.makedirs(output_folder, exist_ok=True)
for snr in snr_values:
    for i in range(num_segments):
        start_sample = int(i * segment_length)
...
output_folder = "/Users/samridhtiwari/Desktop/Binary-UAV-Detection-main/Output/1D Features/ZCR/Drone"
os.makedirs(output_folder, exist_ok=True)
for snr in snr_values:
    for i in range(num_segments):
        start_sample = int(i * segment_length)
...
output_folder = "/Users/samridhtiwari/Desktop/Binary-UAV-Detection-main/Output/1D Features/ZCR/No Drone"
os.makedirs(output_folder, exist_ok=True)
for snr in snr_values:
    for i in range(num_segments):
        start_sample = int(i * segment_length)
...
output_folder = "/Users/samridhtiwari/Desktop/Binary-UAV-Detection-main/Output/1D Features/SC/Drone"
os.makedirs(output_folder, exist_ok=True)
for snr in snr_values:
    for i in range(num_segments):
        start_sample = int(i * segment_length)
...
output_folder = "/Users/samridhtiwari/Desktop/Binary-UAV-Detection-main/Output/1D Features/SC/No Drone"
os.makedirs(output_folder, exist_ok=True)
for snr in snr_values:
    for i in range(num_segments):
        start_sample = int(i * segment_length)
...
output_folder = "/Users/samridhtiwari/Desktop/Binary-UAV-Detection-main/Output/2D Features/MFCC 20/Drone"
os.makedirs(output_folder, exist_ok=True)
for snr in snr_values:
    for i in range(num_segments):
        start_sample = int(i * segment_length)
...
output_folder = "/Users/samridhtiwari/Desktop/Binary-UAV-Detection-main/Output/2D Features/MFCC 20/No Drone"
os.makedirs(output_folder, exist_ok=True)
for snr in snr_values:
    for i in range(num_segments):
        start_sample = int(i * segment_length)
...
output_folder = "/Users/samridhtiwari/Desktop/Binary-UAV-Detection-main/Output/2D Features/Mel 128/Drone"
os.makedirs(output_folder, exist_ok=True)
for snr in snr_values:
    for i in range(num_segments):
        start_sample = int(i * segment_length)
...
output_folder = "/Users/samridhtiwari/Desktop/Binary-UAV-Detection-main/Output/2D Features/Mel 128/No Drone"
os.makedirs(output_folder, exist_ok=True)
for snr in snr_values:
    for i in range(num_segments):
        start_sample = int(i * segment_length)
...
output_folder = "/Users/samridhtiwari/Desktop/Binary-UAV-Detection-main/Output/1D Features/1D_M_CNN/Drone"
os.makedirs(output_folder, exist_ok=True)
for snr in snr_values:
    for i in range(num_segments):
        start_sample = int(i * segment_length)
...
output_folder = "/Users/samridhtiwari/Desktop/Binary-UAV-Detection-main/Output/1D Features/1D_M_CNN/No Drone"
os.makedirs(output_folder, exist_ok=True)
for snr in snr_values:
    for i in range(num_segments):
        start_sample = int(i * segment_length)
